...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
                ...
                <section>
                    ...
                    <div class="row">
                        <div class="twelvecol tac">
                            ...
                            <form id="log_user" action="/" method="Post" class="space_moutain">
                                <div class="form_info_block clearfix">
                                    <label class="dib fl" for="user_login">Pseudo</label>
                                    <input type="text" name="user_login" id="user_login" class="fl">
                                </div>
                                <div class="form_info_block clearfix">
                                    <label class="dib fl" for="user_pwd">Mot de passe</label>
                                    <input type="password" name="user_pwd" id="user_pwd" class="fl">
                                </div>

                                <div class="form_info_block clearfix">
                                    <input type="submit" value="Connexion" name="log_usr">
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <script src="js/_user_login.js"></script>
